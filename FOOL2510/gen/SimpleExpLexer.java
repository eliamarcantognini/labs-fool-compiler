...
public class SimpleExpLexer extends Lexer {
	...
	public static final int
		PLUS=1, TIMES=2, LPAR=3, RPAR=4, NUM=5, WHIESP=6, COMMENT=7, ERR=8;
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PLUS", "TIMES", "LPAR", "RPAR", "NUM", "WHIESP", "COMMENT", "ERR"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "PLUS", "TIMES", "LPAR", "RPAR", "NUM", "WHIESP", "COMMENT", "ERR"
		};
	}
