...
public class BaseASTVisitor<S> {
    ...
    //
    public S visitNode(ProgLetInNode n) {
        throw new UnimplException();
    }

    public S visitNode(BoolTypeNode n) {
        throw new UnimplException();
    }

    public S visitNode(IntTypeNode n) {
        throw new UnimplException();
    }

    public S visitNode(VarNode n) {
        throw new UnimplException();
    }

    public S visitNode(FunNode n) {
        throw new UnimplException();
    }

    public S visitNode(IdNode n) {
        throw new UnimplException();
    }

    public S visitNode(CallNode n) {
        throw new UnimplException();
    }

    public S visitNode(ParNode parNode) {
        throw new UnimplException();
    }
}
